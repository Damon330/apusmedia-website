    ...
    <section id="services" className="py-20 md:py-28 bg-black">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <motion.div
          ...
          className="mb-14"
        >
          <span className="text-white/30 text-xs font-semibold uppercase tracking-widest">Our Services</span>
          <h2 className="font-display font-bold text-white text-3xl md:text-5xl mt-3 max-w-xl leading-tight">
        ...
        >
          {services.map(service => (
            <motion.div
              ...
              className="group bg-white/[0.03] border border-white/6 rounded-2xl p-5 md:p-7 hover:border-white/15 hover:bg-white/[0.05] transition-all duration-300 cursor-default"
            >
              <div className="w-10 h-10 rounded-xl bg-white/6 border border-white/8 flex items-center justify-center mb-5 group-hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/35 text-sm leading-relaxed">{service.description}</p>
            </motion.div>
          ))}
          ...
          <motion.div
            variants={cardVariants}
            className="bg-white rounded-2xl p-5 md:p-7 flex flex-col justify-between"
          >
            <div>
              <h3 className="font-display font-bold text-black text-xl mb-2">Not sure where to start?</h3>
            ...
            <button
              ...
              className="mt-6 bg-black text-white font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-black/80 transition-colors self-start"
            >
              Get a Free Consult →
            </button>
          </motion.div>
