...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
    ...
    return (
      <div
        ...
        style={{
          ...
          boxShadow: isPressed ? "0 1px 2px rgba(0,0,0,0.15)" : isHovered && !isTouchDevice ? "0 4px 14px rgba(0,0,0,0.25)" : "0 3px 8px rgba(0,0,0,0.15)",
          transition,
        }}
      >
        <div className={cn("absolute inset-[1px] transform-gpu rounded-lg will-change-transform", colors.inner)} style={{ transition, filter: isHovered && !isPressed && !isTouchDevice ? "brightness(1.05)" : "none" }} />
        <button
          ref={ref}
          className={cn(
            "relative z-10 m-[1px] rounded-md inline-flex transform-gpu cursor-pointer items-center justify-center overflow-hidden font-semibold will-change-transform outline-none",
            sizeStyles[size],
            colors.button,
            colors.textColor,
            colors.textShadow,
          ...
          style={{ transform: isPressed ? "scale(0.97)" : "scale(1)", transition, filter: isHovered && !isPressed && !isTouchDevice ? "brightness(1.02)" : "none" }}
          {...props}
